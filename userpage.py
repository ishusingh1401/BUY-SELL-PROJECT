# -*- coding: utf-8 -*-
"""
Created on Fri Jan  1 18:21:30 2021
...
def met_welcome(frm):
    menu_category = ["Detergent","Soft Drinks","Soaps","Chocolates","Snacks","Dry Fruits","Sweet Items"]

    menu_category_dict = {"Detergent":"1 Detergent.txt","Soft Drinks":"2 Soft Drinks.txt",
                "Soaps":"3 Soaps.txt","Chocolates":"4 Chocolates.txt",
                "Snacks":"5 Snacks.txt","Dry Fruits":"6 Dry Fruits.txt",
                "Sweet Items":"7 Sweet Items.txt"}
    ...
    def bill_button_operation():
        ...
        if ans=="yes":
            ...
            st = "\t\t\t\tSHOPPING SITE\n\t\t\tDiva.ishu, LUCKNOW-226010\n"
            st += "\t\t\tGST.NO:- 45678345678SSI\n"
            st += "-"*61 + "BILL" + "-"*61 + "\nDate:- "
...
#================Title==============
    ...
    title_frame = Frame(root, bd=8, bg="purple", relief=GROOVE)
    title_frame.pack(side=TOP, fill="x")

    title_label = Label(title_frame, text="SHOPPING SITE", 
                    font=("times new roman", 20, "bold"),bg = "purple", fg="black", pady=5)
    title_label.pack()
...
#==============Customer=============
    ...
    customer_name_label = Label(customer_frame, text="NAME", 
                            font=("arial", 15, "bold"),bg = "lightblue", fg="black")
...
#===============Menu===============
    ...
    menu_frame.place(x=0,y=150,height=585,width=750)

    menu_label = Label(menu_frame, text="MENU", 
                    font=("times new roman", 20, "bold"),bg = "lightgreen", fg="black", pady=10)
    ...
    combo_lable = Label(menu_category_frame,text="SELECT TYPE", 
                        font=("arial", 12, "bold"),bg = "lightgreen", fg="black")
...
#===============Item Frame=============
    ...
    item_frame.place(x=800,y=150,height=230,width=800)
    ...
    order_frame.place(x=800,y=400,height=370,width=680)
